...
var _mono_aot_DSLKIT_get_method = Module['_mono_aot_DSLKIT_get_method'] = (a0) => (_mono_aot_DSLKIT_get_method = Module['_mono_aot_DSLKIT_get_method'] = wasmExports['mono_aot_DSLKIT_get_method'])(a0);
var _sin = Module['_sin'] = (a0) => (_sin = Module['_sin'] = wasmExports['sin'])(a0);
var _cos = Module['_cos'] = (a0) => (_cos = Module['_cos'] = wasmExports['cos'])(a0);
var _mono_aot_DSLKIT_GrammarExamples_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_get_method'] = (a0) => (_mono_aot_DSLKIT_GrammarExamples_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_get_method'] = wasmExports['mono_aot_DSLKIT_GrammarExamples_get_method'])(a0);
var _mono_aot_DSLKIT_GrammarExamples_Ini_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_Ini_get_method'] = (a0) => (_mono_aot_DSLKIT_GrammarExamples_Ini_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_Ini_get_method'] = wasmExports['mono_aot_DSLKIT_GrammarExamples_Ini_get_method'])(a0);
var _mono_aot_DSLKIT_GrammarExamples_MsSql_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_MsSql_get_method'] = (a0) => (_mono_aot_DSLKIT_GrammarExamples_MsSql_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_MsSql_get_method'] = wasmExports['mono_aot_DSLKIT_GrammarExamples_MsSql_get_method'])(a0);
var _mono_aot_DSLKIT_GrammarExamples_SJackson_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_SJackson_get_method'] = (a0) => (_mono_aot_DSLKIT_GrammarExamples_SJackson_get_method = Module['_mono_aot_DSLKIT_GrammarExamples_SJackson_get_method'] = wasmExports['mono_aot_DSLKIT_GrammarExamples_SJackson_get_method'])(a0);
var _mono_aot_DSLKIT_Visualizer_Abstractions_get_method = Module['_mono_aot_DSLKIT_Visualizer_Abstractions_get_method'] = (a0) => (_mono_aot_DSLKIT_Visualizer_Abstractions_get_method = Module['_mono_aot_DSLKIT_Visualizer_Abstractions_get_method'] = wasmExports['mono_aot_DSLKIT_Visualizer_Abstractions_get_method'])(a0);
var _mono_aot_DSLKIT_Visualizer_App_get_method = Module['_mono_aot_DSLKIT_Visualizer_App_get_method'] = (a0) => (_mono_aot_DSLKIT_Visualizer_App_get_method = Module['_mono_aot_DSLKIT_Visualizer_App_get_method'] = wasmExports['mono_aot_DSLKIT_Visualizer_App_get_method'])(a0);
